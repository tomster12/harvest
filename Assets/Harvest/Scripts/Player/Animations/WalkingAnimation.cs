...
public class WalkingAnimation : PlayerAnimation
{
    ...
    public override void Update()
    {
        ...
        Vector3 leftTarget = leftBaseTransform.localPosition + new Vector3(0, 0, offsetZ);
        ...
        Vector3 rightTarget = rightBaseTransform.localPosition + new Vector3(0, 0, -offsetZ);
